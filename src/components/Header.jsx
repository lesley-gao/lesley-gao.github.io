...
function Header() {
    return (
        <div className='flex p-20 gap-32 items-center max-md:flex-col max-md:p-10 max-md:gap-16'>
            ...
            <img src='profile.jpg' alt='profile image' className='rounded-full w-1/3 border-4 border-white/60 shadow-md max-md:w-2/3' />
        </div>
    )
}
