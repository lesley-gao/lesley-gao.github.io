        ...
        <div className='flex p-24 gap-32 items-center max-md:flex-col max-md:p-10 max-md:gap-16' delay={0.1}>
            ...
            <div className=' z-50 flex flex-col space-y-8'>
                ...
                <div className='flex space-x-3 items-center'>
                    <button className='border border-[#504B38] bg-white text-[#504B38] button max-sm:text-sm'><a href={cvLink} target="_blank" rel="noopener noreferrer">Download CV</a></button>
                    <Link to='contact' smooth={true} duration={500}>
                        <button className='border border-white bg-[#4f8a8b] text-white button max-sm:text-sm'>Contact Info</button>
                    </Link>
