...
function AboutMe() {
    ...
    return (
        <div className='flex flex-col items-center justify-center p-30 space-y-3 max-md:p-10'>

            <h4 className='text-center'>Get To Know More</h4>
            <h1 className='text-5xl font-bold text-center mb-10'>About Me</h1>

            <div className='flex gap-20 max-md:gap-10 p-15 items-center justify-center border border-white/70 rounded-4xl shadow-md hover:shadow-lg max-md:flex-col' >
                <img src='avatar-transparent.png' alt='avatar' className='w-1/3 animate-wiggle max-md:w-2/3' />
